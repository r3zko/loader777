...
-- lableoth = ui.new_label("AA", "Fake lag", "                  perfection")
-- labelhead = ui.new_label("AA", "Fake lag", "perfection")
label345 = ui.new_label("AA", "Fake lag", "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
lableoth = ui.new_label("AA", "Fake lag", "\a8AECF1FF•  \aFFFFFFFFUser: tester")
lableoth = ui.new_label("AA", "Fake lag", "\a8AECF1FF•  \aFFFFFFFFBuild: perfect")
lableoth = ui.new_label("AA", "Fake lag", "\a8AECF1FF•  \aFFFFFFFFLast update: 09/01/2024")
label346 = ui.new_label("AA", "Fake lag", "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
client.set_event_callback("pre_render", function()
    ...
    if ui.get(visuals_tab.animfix) == "nasawalk" then
        ...
        if ui.get(visuals_tab.animfix) == "nasawalk" then
            ui.set(legMovement, legsTypes[math.random(1, 3)])
